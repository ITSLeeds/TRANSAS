...
transas <- unique(transas$postcode_final_W4)
...
unique(transas$postcode_clean[!transas$postcode_clean %in% postcodes$postcode])
...
write.csv(st_drop_geometry(transas), "data/postcode_lookup_w4.csv", row.names = FALSE)
#293 vs 301
